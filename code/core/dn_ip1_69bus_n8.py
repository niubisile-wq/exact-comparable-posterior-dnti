# -*- coding: utf-8 -*-
"""IP1 69-bus: 补种子500/1000/1500 → n=8 Wilcoxon"""
...
TEST_SEED = 77
N_BUS = 69
print(f"Device: {DEVICE}  IP1-69bus n8: extra seeds {NEW_SEEDS}")

EXISTING_5 = {
    42:   {'ais': 0.402, 'nre': 0.363},
    123:  {'ais': 0.402, 'nre': 0.359},
    456:  {'ais': 0.402, 'nre': 0.346},
    789:  {'ais': 0.402, 'nre': 0.375},
    2024: {'ais': 0.402, 'nre': 0.354},
}
...
for seed in NEW_SEEDS:
    ...
    if os.path.exists(save_path):
        ...
        torch.save({'model_state': model.state_dict(), 'seed': seed,
                    'N_TOPOS': N_TOPOS, 'K_FIXED': K_FIXED, 'SIGMA': SIGMA, 'N_BUS': N_BUS}, save_path)
...
with open(f"{SAVE_DIR}\\ip1_69bus_n8_result.txt", 'w', encoding='utf-8') as f:
    f.write('\n'.join(out) + '\n')
print(f"Saved: ip1_69bus_n8_result.txt")
