# -*- coding: utf-8 -*-
"""IP-C 69-bus: 补种子500/1000/1500 → n=8 Wilcoxon"""
...
N_BUS = 69
print(f"Device: {DEVICE}  IP-C-69bus n8: extra seeds {NEW_SEEDS}")

# 已验证的5种子rob结果（来源：ipc_69bus_5seed_result.txt rng_seed=77）
EXISTING_ROB = {
    42:   {'rob10': 0.322, 'rob30': 0.304},
    123:  {'rob10': 0.340, 'rob30': 0.305},
    456:  {'rob10': 0.332, 'rob30': 0.318},
    789:  {'rob10': 0.313, 'rob30': 0.305},
    2024: {'rob10': 0.329, 'rob30': 0.300},
}
...
# 加载 V_library
print("Loading V_library_69bus.npz...")
...
print(f"Naive @10%={nai10:.3f}  @30%={nai30:.3f}  (expected ~0.208 / ~0.073)")
...
print(f"\n{'='*60}")
print(f"IP-C-69bus n=8 SUMMARY  nai10={nai10:.3f}  nai30={nai30:.3f}")
...
with open(f"{SAVE_DIR}\\ipc_69bus_n8_result.txt", 'w', encoding='utf-8') as f:
    f.write('\n'.join(out) + '\n')
print(f"Saved: ipc_69bus_n8_result.txt")
