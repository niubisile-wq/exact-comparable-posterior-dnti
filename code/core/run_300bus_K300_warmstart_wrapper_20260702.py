...
m.K_ATTACK = 300
m.OUT_NAME = "300bus_redundant_sensing_K300_warmstart_attack_20260702.txt"
m.N_TRAIN = 160000
m.N_VAL = 5000
m.N_FINAL = 8000
m.EPOCHS = 8
...
def exact_curve_k300(lib):
    rows = []
    for k, seed in [(150, 150404), (180, 180404), (220, 220404), (240, 240404), (260, 260404), (280, 280404), (300, 300404)]:
...
m.exact_curve = exact_curve_k300
m.main()
